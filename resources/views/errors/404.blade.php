    ...
    <div class="maintenance-container">
        ...
        <div class="maintenance-card">
            ...
            <h2>Contenu introuvable</h2>
                ...
                <p>Merci de vérifier l'URL ou de nous contacter si vous pensez qu'il s'agit d'une erreur.</p>
            </div>
         
            
                <div class="error-actions">
                <a href="mailto:frontdesk@nmieducation.com" class="btn btn-primary">
